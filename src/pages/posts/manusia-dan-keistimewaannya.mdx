...
<Picture
  src="https://source.unsplash.com/oko_4WnoM98/1600x1000"
  alt="Ilustrasi bayi manusia"
...
<Picture
  src="https://source.unsplash.com/LY1eyQMFeyo/1600x1000"
  alt="Ilustrasi peradaban manusia"
  widths={[1140, 960, 720, 540, 360]}
  aspectRatio={16 / 10}
  sizes="(min-width: 1200px) 1140px, (min-width: 992px) 960px, (min-width: 768px) 720px, (min-width: 576px) 540px, 100vw"
  formats={['avif', 'webp', 'jpeg']}
